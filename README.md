...
- <div style="display: flex; align-items: left;">
  <img src="https://github.com/shayestehfard/shayestehfard/blob/main/google-scholar4372.jpg" alt="Logo" width="40" height="40">
  <h1 style="margin-left: 20px;">Google Scholar Profile </h1>
</div>
